...
<nav class="navbar navbar-expand-lg navbar-dark  website-pt-40px website-pb-40px">
    <div class="container-lg">
        <a class="navbar-brand" href="#">
            <img src="{{ asset('imgs/logo-main.png') }}" alt="WebSiteName Logo"  class="d-inline-block align-text-top website-logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="btn btn-primary-website btn-website-round nav-contact-btn" href="#"><i class="bi bi-person-plus"></i> Contact</a>
                </li>
                {{-- <li class="nav-item">
